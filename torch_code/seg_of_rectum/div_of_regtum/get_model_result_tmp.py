...
def predict(img_path, ckpt_path, model_name, train_phrase, display_path, mask_path, model_res_path):
    ...
    if model_name == 'emb':
        ...
        set = Dataset(img_path, img_path, train_phrase)
...
if __name__ == "__main__":
    display_path = '/home/zhangqianru/data/seg_of_rectum/div_of_rectum/model_results/display_tmp'
    mask_path = '/home/zhangqianru/data/seg_of_rectum/div_of_rectum/model_results/mask_tmp'
    ...
    for model in model_set:
        ...
        predict(img_path, ckpt_path, model, 'test', display_path, mask_path, model_res_path)
    pass
