from torch.nn import Module, Sequential, ReLU, Conv2d, BatchNorm2d, AvgPool2d, MaxPool2d, AdaptiveAvgPool2d, Linear
import torch

class Conv2d_BN(Module):
    def __init__(self, channels_in, channels_out, kernel_size, stride, padding, acti=ReLU()):
        super(Conv2d_BN, self).__init__()
        self.conv2d_bn = Sequential(
            Conv2d(channels_in, channels_out, kernel_size, stride, padding),
...
class InceptionB(Module):
    def __init__(self, channels_in):
        ...
        self.branch_pool = MaxPool2d(3, stride=2)  # channels_in
...
class InceptionE(Module):
    def __init__(self, channels_in):
        ...
        self.branch3x3_2a = Conv2d_BN(384, 384, (3, 1), stride=1, padding=(1, 0))
        # 768 channels
...
class GuguNetV3(Module):
    def __init__(self, channels_in, channels_out):
        super(GuguNetV3, self).__init__()
